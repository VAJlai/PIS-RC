<template>
  ...
  <el-card
    ...
    id="card-show"
  >
    <el-button @click="submitForm(ruleFormRef)" id="button-style">
      <el-icon :size="26">
        <Search />
      </el-icon>
    </el-button>
    <el-col :span="28" :offset="5" style="margin-top: 0rem">
      ...
      >
        ...
        >
          ...
          >
            <template v-for="item in databaseInfo.databaseFirst">
              <el-radio :label="item.baseLabel" style="margin-right: 16px">{{
                item.name
              }}</el-radio>
            </template>
          </el-radio-group>
        ...
        <el-form-item
          v-if="ruleForm.database >= 6 && ruleForm.database < 13"
          style="width: 100%; flex-wrap: nowrap"
        >
          <el-radio-group v-model="ruleForm.database">
        ...
        <el-form-item
          ...
          style="font-size: 10px; height: 1rem; width: 80vh"
        >
    ...
    <img
      ...
      id="tab-show"
      @click="clickTab"
      src="../../../../assets/BasicSearch/show-icon.png"
    />
...
export default {
  ...
  setup() {
    ...
    const getInfo = function () {
      ...
      console.log(param)
      PaperService.paperSearchAdvanced(param).then((res: any) => {
